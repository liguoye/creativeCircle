      ...
      this.$ajax
        .get("goods/add", {
          params: {
            ...
            img: this.ruleForm.phone,
            mobile_img: this.ruleForm.province,
            abbreviation: this.ruleForm.city,
            kg: this.ruleForm.area,
            class_name: this.ruleForm.address,
            tmall_img: this.ruleForm.img,
            through_train_img: this.ruleForm.img
          }
        })
        .then(res => {
